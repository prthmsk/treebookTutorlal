...
class ClinicsControllerTest < ActionController::TestCase
  ...
  test "should create clinic" do
    assert_difference('Clinic.count') do
      post :create, clinic: { address: @clinic.address, doctor: @clinic.doctor, lat: @clinic.lat, lng: @clinic.lng, name: @clinic.name }
    end
  ...
  test "should update clinic" do
    patch :update, id: @clinic, clinic: { address: @clinic.address, doctor: @clinic.doctor, lat: @clinic.lat, lng: @clinic.lng, name: @clinic.name }
    assert_redirected_to clinic_path(assigns(:clinic))
  end
